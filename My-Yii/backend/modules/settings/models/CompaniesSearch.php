...
class CompaniesSearch extends Companies
{
    ...
    public function search($params)
    {
        ...
        if($this->company_start_date){
            $formateDate = date_format(date_create($this->company_start_date),"Y-m-d");
            $query->andFilterWhere(['like','DATE(company_start_date)',$formateDate]);
        }
