    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                $imagename = $model->receiver_name;
                    $model->attachement = UploadedFile::getinstance($model,'attachement'); 
                    $model->attachement->saveAs('attachments/'.$imagename.'.'.$model->attachement->extension);
                    //save file uploaded to db
                    $model->attachement = 'attachments/'.$imagename.'.'.$model->attachement->extension; 
                $model->save();
